...
- Planned UI is GTK: a standalone approval/settings control surface exists, persists TOML preferences in the store directory, and the daemon-side GTK integration still needs IPC wiring.
